...
const ActionItem  = ({product}) => {
    ...
    const buyNow = () => {
        let response = payUsingPaytm({amount:400, email:'laptop123@gmail.com'});
        let information = {
            action:'https://pguat.paytm.com/PayTMSecured/app/auth/login',
            params:response
        }
        post(information);
    }
    ...
    return(
        <LeftContainer>
            <Box style={{padding:'15px 20px',border:'1px solid #f0f0f0',width:'89%'}} >
                <Image src={product.detailUrl} alt="product" style={{width:'100%'}} />
            </Box>
